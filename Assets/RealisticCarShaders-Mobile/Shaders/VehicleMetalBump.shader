...
Shader "Mobile/ Realistic Car Shaders/Metal" 
{
	...
	void surf(Input IN, inout SurfaceOutput s)
	{
		...
		s.Emission = reflectionResult * reflectionResult + bodySpecularMask * reflectionResult * reflectionResult;
        #endif
		...
		// combine everything
		s.Albedo = BodyDiffuse * bodySpecularMask * _ShininessIntensity;
	}
	ENDCG
	}
	FallBack "Standard"
	CustomEditor "VehicleMetalBump_Editor"
}
